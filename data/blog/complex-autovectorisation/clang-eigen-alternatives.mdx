...
Surprisingly though, it seems like there's no real difference in terms of number of cycles, so I guess the benefit is only in higher precision using FMA.
